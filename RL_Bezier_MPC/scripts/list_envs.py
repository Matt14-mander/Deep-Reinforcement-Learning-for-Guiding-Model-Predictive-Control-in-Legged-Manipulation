...
All the environments are registered in the `RL_Bezier_MPC` extension. They start
...
import RL_Bezier_MPC.tasks  # noqa: F401


def main():
    """Print all environments registered in `RL_Bezier_MPC` extension."""
