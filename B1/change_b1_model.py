...
# Loading the b1 model
b1 = example_robot_data.load("b1")

# Defining the initial state of the robot
q0 = b1.model.referenceConfigurations["standing"].copy()
v0 = pinocchio.utils.zero(b1.model.nv)
x0 = np.concatenate([q0, v0])

# Setting up the 3d walking problem
lfFoot, rfFoot, lhFoot, rhFoot = "FR_foot", "FL_foot", "RR_foot", "RL_foot"
gait = SimpleQuadrupedalGaitProblem(b1.model, lfFoot, rfFoot, lhFoot, rhFoot)
