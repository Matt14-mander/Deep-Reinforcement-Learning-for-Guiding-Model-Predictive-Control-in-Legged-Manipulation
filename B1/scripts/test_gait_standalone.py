...
from quadruped_mpc.trajectory.bezier_foot_trajectory import BezierFootTrajectory
...
def test_gait_pipeline(
    ...
    if trajectory_type in ["curve_left", "curve_right"]:
        ...
        if trajectory_type == "curve_left" and left_avg < right_avg:
            print("  [OK] Correct: inner (left) feet take shorter steps")
        elif trajectory_type == "curve_right" and right_avg < left_avg:
            print("  [OK] Correct: inner (right) feet take shorter steps")
